...
CREATE POLICY admin_insert_invoices ON public.invoices FOR INSERT WITH CHECK (true);
CREATE POLICY admin_read_invoices ON public.invoices FOR SELECT USING (true);
CREATE POLICY admin_update_invoices ON public.invoices FOR UPDATE USING (true);
...
CREATE POLICY passkey_challenges_insert ON public.passkey_challenges FOR INSERT WITH CHECK (true);
CREATE POLICY passkey_challenges_select ON public.passkey_challenges FOR SELECT USING (true);
CREATE POLICY passkey_challenges_delete ON public.passkey_challenges FOR DELETE USING (true);
...
CREATE POLICY cron_job_runs_service ON public.cron_job_runs FOR ALL USING (true);
...
CREATE POLICY admin_all_summaries ON public.monthly_summaries FOR ALL USING (true);

DROP POLICY IF EXISTS "business_settings_admin_all" ON public.business_settings;
CREATE POLICY "Service role full access on business_settings" ON public.business_settings
...
CREATE POLICY admin_insert_transactions ON public.business_transactions FOR INSERT WITH CHECK (true);
CREATE POLICY admin_read_transactions ON public.business_transactions FOR SELECT USING (true);
