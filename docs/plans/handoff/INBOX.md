...
| in-progress | codex | Welle D: AI-Test-User-Cleanup-Execute-Pfad | `lib/admin/ai-test-users-cleanup-dry-run.ts` + `lib/admin/ai-test-users-cleanup-execute.ts` + `scripts/ai-test-users-cleanup-execute.ts` + `__tests__/scripts/ai-test-users-cleanup-dry-run.test.ts` + `__tests__/scripts/ai-test-users-cleanup-execute.test.ts` + `docs/plans/handoff/INBOX.md` | 2026-05-01 vormittag | Execute-Pfad mit TDD, harten Safety-Gates und ohne Prod-Ausfuehrung lokal committed | 2026-05-01 vormittag |
