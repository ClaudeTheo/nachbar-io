...
import {
  type ChatMessage, type ChatResponse, type ToolResult, type ToolConfirmation,
  WELCOME_MESSAGE, generateId, loadMessages, saveMessages, persistToSupabase, loadFromSupabase,
} from './companion-chat-utils';

export type { ChatMessage, ToolResult, ToolConfirmation } from './companion-chat-utils';
...
export interface UseCompanionChatReturn {
  ...
  handleConfirmTool: (confirmation: ToolConfirmation, msgId: string) => Promise<void>;
