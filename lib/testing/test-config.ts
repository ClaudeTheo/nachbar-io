...
// ============================================================
export const TEST_CONFIG_VERSION = '1.1';
...
export const TEST_PATHS: TestPath[] = [
  ...
  // ─────────────────────────────────────────────────
  // 11. Pflege-Modul (Care)
  // ─────────────────────────────────────────────────
  {
    id: 'care',
    name: 'Pflege-Modul',
    icon: 'Heart',
    description: 'Pflege-Dashboard, Check-in, SOS, Medikamente, Termine, Helfer, Berichte',
    estimatedMinutes: 20,
    order: 11,
    points: [
      {
        ...
        description: 'Pflege-Dashboard oeffnen — Status-Karten (Check-in, SOS, Medikamente, Termine, Helfer) werden angezeigt.',
        route: '/care',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O2',
        title: 'Check-in durchfuehren',
        description: 'Check-in-Seite oeffnen und "Mir geht es gut" oder "Nicht so gut" waehlen. Status wird gespeichert.',
        route: '/care/checkin',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O3',
        title: 'SOS-Alarm ausloesen',
        description: 'SOS-Button druecken, Kategorie waehlen (z.B. "Allgemeine Hilfe"). Alarm wird erstellt und erscheint im Dashboard.',
        route: '/care',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O4',
        title: 'SOS-Alarm annehmen',
        description: 'Tester B sieht den SOS-Alarm von Tester A und nimmt ihn an. Status wechselt auf "Hilfe unterwegs".',
        route: '/care/sos',
        mode: 'pair',
        version: '1.1',
        active: true,
        tags: ['critical'],
        partnerInstructions: 'Tester A muss vorher einen SOS-Alarm ausgeloest haben.',
      },
      {
        id: 'O5',
        title: 'SOS-Alarm abschliessen',
        description: 'Offenen SOS-Alarm als erledigt markieren. Alarm verschwindet aus der aktiven Liste.',
        route: '/care/sos',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O6',
        title: 'Medikament hinzufuegen',
        description: 'Medikamenten-Seite oeffnen und neues Medikament mit Name und Einnahmezeit anlegen.',
      ...
      {
        id: 'O7',
        title: 'Medikament als eingenommen markieren',
        description: 'Faelliges Medikament als "eingenommen" bestaetigen. Status im Dashboard aktualisiert sich.',
        route: '/care/medications',
        mode: 'solo',
        version: '1.1',
        active: true,
      },
      {
        ...
        description: 'Termin-Seite oeffnen und neuen Termin mit Titel, Datum und Uhrzeit anlegen.',
      ...
      },
      {
        ...
        description: 'Anstehenden Termin als "bestaetigt" markieren. Status aendert sich.',
        route: '/care/appointments',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O10',
        title: 'Helfer-Registrierung',
        description: 'Helfer-Seite oeffnen und sich als Helfer registrieren. Rolle waehlen (Nachbar/Angehoerige/Pflegedienst).',
        route: '/care/helpers',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O11',
        title: 'Berichte einsehen',
        description: 'Berichte-Seite oeffnen — Check-in-Verlauf, SOS-Historie und Medikamenten-Compliance werden angezeigt.',
        route: '/care/reports',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O12',
        title: 'Aktivitaetsprotokoll pruefen',
        description: 'Protokoll-Seite oeffnen — alle Pflege-Aktivitaeten (Check-ins, SOS, Medikamente) sind chronologisch aufgelistet.',
        route: '/care/audit',
        mode: 'solo',
        version: '1.1',
        active: true,
      ...
      {
        id: 'O13',
        title: 'Abo-Plan anzeigen',
        description: 'Abo-Plan-Seite oeffnen — aktueller Plan und verfuegbare Features werden angezeigt.',
        route: '/care/subscription',
        mode: 'solo',
        version: '1.1',
        active: true,
      },
      {
        id: 'O14',
        title: 'Feature-Gating pruefen',
        description: 'Nicht verfuegbare Features (je nach Abo-Plan) werden im Dashboard NICHT angezeigt — keine toten Links.',
        route: '/care',
        mode: 'solo',
        version: '1.1',
        active: true,
