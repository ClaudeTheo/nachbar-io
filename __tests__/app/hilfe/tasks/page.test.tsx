...
const mockTasks = [
  { id: 'h1', title: 'Einkaufen', description: 'Aldi', status: 'open', category: 'Einkaufen', created_at: '2026-03-27T10:00:00Z', scheduled_date: '2026-03-28', requester: { display_name: 'Frau Mueller' } },
  { id: 'h2', title: 'Gartenarbeit', description: 'Rasen', status: 'in_progress', category: 'Garten', created_at: '2026-03-26T10:00:00Z', scheduled_date: null, requester: { display_name: 'Herr Schmidt' } },
  { id: 'h3', title: 'Arztbegleitung', description: '', status: 'completed', category: 'Begleitung', created_at: '2026-03-25T10:00:00Z', scheduled_date: null, requester: { display_name: 'Frau Weber' } },
];
