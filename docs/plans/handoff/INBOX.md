...
| in-progress | codex | E2E Local-Production Start-Script gegen Env-Drift | `package.json` + `__tests__/config/package-scripts.test.ts` + `tests/e2e/README.md` + `docs/plans/handoff/INBOX.md` | 2026-05-01 nachmittag | `start:local`/Doku gegen `.env.production.local`-Drift test-first umgesetzt und lokal verifiziert | 2026-05-01 nachmittag |
