...
import { grantConsent } from "@/modules/memory/services/consent.service";
import type {
  MemoryApiResponse,
  MemoryConsentType,
...
export async function POST(
  ...
  try {
    ...
    // (DSGVO Art. 7 Abs. 1) und nicht via Pflege-Link delegierbar. Caregiver
    // darf den Status sehen (RLS Mig 174), aber nicht im Namen des Seniors
    // erteilen.
