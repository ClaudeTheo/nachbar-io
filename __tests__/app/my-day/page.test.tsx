...
vi.mock("lucide-react", () => ({
  Heart: (props: Record<string, unknown>) => (
    <svg data-testid="icon-heart" {...props} />
  ),
  Pill: (props: Record<string, unknown>) => (
    <svg data-testid="icon-pill" {...props} />
  ),
  ...
  Smile: (props: Record<string, unknown>) => (
    <svg data-testid="icon-smile" {...props} />
  ),
  Meh: (props: Record<string, unknown>) => (
    <svg data-testid="icon-meh" {...props} />
  ),
        ...
        return {
          select: () => ({
            eq: () => ({
              order: () => ({
                limit: () =>
                  Promise.resolve({ data: mockHeartbeats, error: null }),
              }),
            }),
          }),
        };
...
describe("MyDayPage", () => {
  ...
  it("zeigt Schnellaktionen mit 80px Touch-Targets", async () => {
    ...
    const links = screen
      .getByTestId("quick-actions-myday")
      .querySelectorAll("a");
