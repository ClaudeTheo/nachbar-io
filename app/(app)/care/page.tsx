...
import { SosButton } from "@/modules/care/components/sos/SosButton";
    ...
    <CareConsentGate>
      <div className="px-4 py-6 space-y-6">
        ...
        <PageHeader
          title={
            <>
              <Heart className="h-6 w-6 text-quartier-green" /> Pflege &amp;
              Seniorenhilfe
            </>
          }
        ...
        {trustLevel === "new" && (
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            ...
            <p className="text-xs text-amber-700 mt-1">
              Bitten Sie zwei Nachbarn um Bestätigung, damit Sie alle Funktionen
              nutzen können.
            </p>
            <Link
              href="/vouching"
            ...
            {checkinStatus ? (
              <div className="mt-1">
                {checkinStatus.allCompleted ? (
                  <p className="text-lg font-semibold text-quartier-green">
                    Alle erledigt
                  </p>
                ) : (
                  <>
          ...
          >
            ...
            {helperCount !== null ? (
              <p className="text-lg font-semibold mt-1 text-anthrazit">
                {helperCount}{" "}
                {helperCount === 1 ? "verifiziert" : "verifiziert"}
              </p>
            ) : (
              <p className="text-lg font-semibold mt-1 text-muted-foreground">
                —
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            ...
            {isVerifiedHelper &&
              (helperRole === "relative" || helperRole === "care_service") && (
                <Link
        ...
        <div className="rounded-xl bg-quartier-green/10 p-4 text-sm text-anthrazit">
          ...
          <p className="mt-1 text-muted-foreground">
            Pflege-Modul vollständig: SOS, Check-ins, Medikamente, Termine,
            Helfer, Berichte, Abo-Verwaltung und Aktivitätsprotokoll.
          </p>
        </div>
      </div>
    </CareConsentGate>
