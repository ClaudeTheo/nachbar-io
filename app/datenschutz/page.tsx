      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-anthrazit/80">
          ...
          <section>
            ...
            <p>
              QuartierApp ist eine Kommunikationsplattform für
              Nachbarschaftshilfe und Quartiersvernetzung. Wir verarbeiten
              personenbezogene Daten nur, soweit dies zur Bereitstellung der
              Plattform erforderlich ist oder Sie ausdrücklich eingewilligt
              haben.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="ml-4 list-disc space-y-1">
              <li>
                ...
                Registrierung, Nutzung der Plattform, Abwicklung
                kostenpflichtiger Funktionen
              </li>
              <li>
                <strong>Art. 6 Abs. 1 lit. f DSGVO</strong> — Berechtigtes
                Interesse: Sicherheit der Plattform, Missbrauchsverhinderung,
            ...
            <p className="mt-3">
              ...
              gesundheitsbezogene Angaben machen oder daraus besondere
              Kategorien personenbezogener Daten im Sinne von Art. 9 Abs. 1
              DSGVO hervorgehen, erfolgt die Verarbeitung ausschließlich auf
              Grundlage einer gesonderten, ausdrücklichen Einwilligung gemäß
          ...
          <section>
            ...
            <h3 className="mt-3 font-semibold">
              5.2 Biometrische Anmeldung (Passkeys)
            </h3>
            <p className="mb-1">
              Sie können optional eine biometrische Anmeldung (Face ID, Touch
              ID, Windows Hello) aktivieren. Dabei werden{" "}
              <strong>keine biometrischen Daten</strong> an unseren Server
              übermittelt. Die Prüfung von Fingerabdruck oder Gesicht erfolgt
              ausschließlich auf Ihrem Gerät.
            </p>
            <ul className="ml-4 list-disc space-y-1">
              <li>
                Gespeichert wird nur ein kryptographischer Schlüssel (Public
                Key), ein Gerätename und ein Signatur-Zähler
              </li>
              <li>
                Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO
                (Vertragsdurchführung) — die Aktivierung erfolgt freiwillig
                durch Sie
              </li>
              <li>
                Löschung: Jederzeit in den Profileinstellungen unter
                &bdquo;Biometrische Anmeldung&ldquo;
              </li>
              <li>
                Bei Kontolöschung werden alle Passkey-Daten automatisch
                mitgelöscht
              </li>
            </ul>
            ...
            <ul className="ml-4 list-disc space-y-1">
              ...
              <li>
                Direktnachrichten (nur zwischen Sender und Empfänger sichtbar)
              </li>
              ...
              <li>
                Reputationsdaten (aggregierte Statistiken Ihrer Aktivitäten)
              </li>
            </ul>
            ...
            <ul className="ml-4 list-disc space-y-1">
              <li>
                <strong>Tagescheck:</strong> Statusmeldung (gut / geht so /
              ...
              <li>
                <strong>Erinnerungen:</strong> Von Ihnen eingegebene
                Erinnerungstexte, Zeitpunkte, Bestätigungen
              </li>
              <li>
                ...
                einsehen — nicht jedoch Nachrichteninhalte, Standort oder
                Details
              </li>
              <li>
                <strong>Einkaufshilfe:</strong> Einkaufslisten, Zuweisungen an
                Helfer
              </li>
            </ul>
            ...
            <ul className="ml-4 list-disc space-y-1">
              <li>
                <strong>Angehörigen-Videoanrufe:</strong>{" "}
                Peer-to-Peer-Verbindung (WebRTC). Audio- und Videodaten werden
                direkt zwischen den Teilnehmern übertragen und nicht auf unseren
                Servern gespeichert.
              </li>
              <li>
                <strong>Ärztliche Videosprechstunde:</strong> Über einen
                KBV-zertifizierten Drittanbieter (sprechstunde.online). Für die
                Datenverarbeitung innerhalb der Videosprechstunde gelten die
            ...
            <p>
              ...
              ausschließlich durch unseren Zahlungsdienstleister Stripe
              verarbeitet. Wir speichern keine Kreditkarten- oder Bankdaten. Wir
              erhalten von Stripe lediglich eine Referenz-ID sowie den
              Zahlungsstatus.
            </p>
            ...
            <ul className="ml-4 list-disc space-y-1">
              ...
              <li>
                Push-Subscription-Daten (Endpoint, Schlüssel) für
                Benachrichtigungen
              </li>
              <li>
                Gerätetyp und Browser (für Kompatibilität, nicht für Tracking)
              </li>
            </ul>

            <h4 className="mt-3 text-sm font-semibold">
              5.9 Standortdaten bei Hilferufen
            </h4>
            <p className="mt-1 text-sm text-muted-foreground">
              Bei der Erstellung eines Hilferufs können Sie freiwillig Ihren
              GPS-Standort (Breitengrad, Längengrad) teilen. Die Erfassung
              erfolgt über die Geolocation-API Ihres Browsers.
            </p>
            <ul className="mt-1 list-disc pl-5 text-sm text-muted-foreground space-y-1">
              ...
              <li>
                <strong>Zweck:</strong> Nachbarschaftliche Koordination bei
                Hilferufen
              </li>
              <li>
              ...
              <li>
                ...
                (Plus) sehen den genauen Standort, Organisationen (Pro
                Community) und Ärzte (Pro Medical) sehen zunächst einen
                ungefähren Bereich (~50m), nach Helfer-Bestätigung den genauen
                Standort
              </li>
              <li>
                <strong>Freie Nutzer:</strong> Sehen keinen Standort, nur den
                Straßennamen
              </li>
              <li>
              ...
              <li>
                ...
                hinterlegte Haushaltsadresse als ungefährer Standort verwendet
                (sofern Standortfreigabe aktiv)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Das Care-Modul verarbeitet besondere Kategorien personenbezogener
              Daten (Gesundheitsdaten) gemäß Art. 9 Abs. 1 DSGVO. Die
              Verarbeitung erfolgt ausschließlich auf Grundlage Ihrer
              ausdrücklichen Einwilligung (Art. 9 Abs. 2 lit. a DSGVO).
            </p>
            <p className="mt-2">
              Sie können für folgende Bereiche einzeln einwilligen oder die
              Einwilligung widerrufen:
            </p>
            <ul className="mt-1 list-disc pl-5 space-y-1">
              <li>
                <strong>SOS-Hilferufe:</strong> Kategorie, Freitext-Notizen,
                GPS-Standort
              </li>
              <li>
                <strong>Täglicher Check-in:</strong> Stimmungsabfrage,
                persönliche Notizen
              </li>
              <li>
                <strong>Medikamenten-Verwaltung:</strong> Medikamentennamen,
                Dosierungen, Einnahmezeiten
              </li>
              <li>
                <strong>Pflegeprofil:</strong> Pflegegrad, medizinische Notizen,
                Versicherungsnummer
              </li>
              <li>
                <strong>Notfallkontakte:</strong> Telefonnummern und Beziehungen
                (erfordert SOS-Einwilligung)
              </li>
            </ul>
            <p className="mt-2">
              <strong>Widerruf:</strong> Sie können jede Einwilligung jederzeit
              unter „Care-Modul → Einwilligungen&rdquo; widerrufen. Der Widerruf
              gilt ab sofort und berührt nicht die Rechtmäßigkeit der bis dahin
              erfolgten Verarbeitung (Art. 7 Abs. 3 DSGVO). Bei Widerruf können
              Sie optional auch die zugehörigen Daten löschen lassen.
            </p>
            <p className="mt-2">
              <strong>Nachweispflicht:</strong> Zeitpunkt und Version jeder
              Einwilligung werden protokolliert (Art. 7 Abs. 1 DSGVO). Die
              Protokolle werden 10 Jahre aufbewahrt.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="ml-4 list-disc space-y-1">
              ...
              <li>
                <strong>Quartiers-Organisationen (Pro):</strong> Nur
                anonymisierte Statistiken und aggregierte Daten, keine
                personenbezogenen Einzeldaten
              </li>
              <li>
                <strong>Ärzte (Pro Medical):</strong> Nur Daten eigener
                Patienten im Rahmen der Terminbuchung
              </li>
            </ul>
            ...
            <p>
              Stripe Inc., USA/Irland. Verarbeitet Zahlungsdaten für
              kostenpflichtige Funktionen. Stripe ist als eigenständiger
              Verantwortlicher für die Zahlungsverarbeitung tätig und unterliegt
              dem EU-US Data Privacy Framework sowie eigenen
            ...
            <p>
              Wir nutzen <strong>kein Google Analytics</strong>, keine
              Tracking-Pixel, keine Social-Media-Plugins und keine Werbedienste.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              QuartierApp verwendet ausschließlich{" "}
              <strong>technisch notwendige Cookies</strong> für die
              Authentifizierung (Supabase Auth Session). Diese sind für den
              Betrieb der Plattform zwingend erforderlich und benötigen keine
              Einwilligung (§ 25 Abs. 2 TDDDG / ePrivacy-Ausnahme).
            </p>
            <p className="mt-2">
              Zusätzlich werden lokale Speicherwerte (localStorage) verwendet,
              um Einstellungen wie den PWA-Installationshinweis oder die
              Bestätigung von Hinweisdialogen zu speichern. Diese Werte
          ...
          <section>
            ...
            <ul className="ml-4 mt-2 list-disc space-y-1">
              ...
              <li>
                <strong>Einschränkung</strong> (Art. 18 DSGVO) — Einschränkung
                der Verarbeitung
              </li>
              <li>
                <strong>Datenübertragbarkeit</strong> (Art. 20 DSGVO) — Export
                Ihrer Daten in maschinenlesbarem Format
              </li>
              <li>
                <strong>Widerspruch</strong> (Art. 21 DSGVO) — Widerspruch gegen
          ...
          <section>
            ...
            <p>
              ...
              &bdquo;Konto löschen&ldquo; selbständig löschen. Bei Löschung
              Ihres Kontos werden alle personenbezogenen Daten innerhalb von 30
              Tagen unwiderruflich gelöscht. Dies umfasst:
            </p>
            <ul className="ml-4 mt-2 list-disc space-y-1">
          ...
          <section>
            ...
            <ul className="ml-4 list-disc space-y-1">
              <li>
                Verschlüsselung aller Daten während der Übertragung (TLS/HTTPS)
              </li>
              <li>Verschlüsselung ruhender Daten in der Datenbank (AES-256)</li>
              <li>
                Zusätzliche Feldverschlüsselung (AES-256-GCM) für besonders
                sensible Daten
              </li>
          ...
          <section>
            ...
            <p>
              ...
              Artikel geteilt, Veranstaltungen besucht). Diese Berechnung
              erfolgt ausschließlich aus bereits vorhandenen Interaktionsdaten.
            </p>
            <ul className="ml-4 mt-2 list-disc space-y-1">
              <li>
                Keine zusätzlichen Daten werden für die Reputation erhoben
              </li>
              <li>
                Die detaillierte Statistik ist nur für Sie selbst sichtbar
              </li>
              <li>Andere Nutzer sehen nur ein kleines Level-Symbol</li>
              <li>Es gibt kein Ranking und keinen Wettbewerb</li>
              <li>
                Die Reputation wird bei Kontolöschung vollständig gelöscht
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              QuartierApp richtet sich nicht an Kinder. Soweit eine Nutzung
              durch Minderjährige erfolgt, darf dies nur mit Zustimmung der
