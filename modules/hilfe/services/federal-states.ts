...
const FEDERAL_STATE_RULES: FederalStateRule[] = [
  ...
  },
  {
    ...
    tax_note: 'Ggf. steuerfrei nach § 3 Nr. 36 EStG (Aufwandsentschaedigung fuer Pflegepersonen); Bayerische Ehrenamtsversicherung bietet subsidiären Versicherungsschutz',
