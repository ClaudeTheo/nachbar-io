...
export const RATHAUS_LINKS: RathausLink[] = [
  {
    ...
    url: "https://www.bad-saeckingen.de/de/rathaus-verwaltung/maengelmelder",
    icon: "alert-triangle",
  },
  {
  ...
  },
  {
    ...
    url: "https://www.bad-saeckingen.de/de/rathaus-verwaltung/gemeinderat",
    icon: "landmark",
  },
  {
    label: "Veranstaltungskalender",
    description: "Aktuelle Veranstaltungen in Bad Säckingen",
    url: "https://www.bad-saeckingen.de/de/tourismus-freizeit/veranstaltungen",
    icon: "calendar",
  },
  {
    label: "Stadtseniorenrat",
    description: "Anlaufstelle für ältere Bürgerinnen und Bürger",
    url: "https://www.bad-saeckingen.de/de/leben-wohnen/senioren",
    icon: "heart-handshake",
  },
  {
    label: "Pflegestützpunkt",
    description: "Beratung rund um Pflege und Unterstützung",
    url: "https://www.bad-saeckingen.de/de/leben-wohnen/pflege",
    icon: "shield-check",
  },
];
