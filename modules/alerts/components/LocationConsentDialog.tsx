    ...
    <div className="rounded-2xl border bg-card p-6 shadow-soft">
      <div className="mb-4 flex items-center gap-3">
        ...
        <h3 className="text-lg font-semibold text-anthrazit">
          Standort bei Hilferufen teilen?
        </h3>
      </div>

      <p className="mb-3 text-sm text-muted-foreground">
        Wenn Sie Ihren Standort teilen, können Angehörige und bestätigte Helfer
        sehen, wo Sie Hilfe benötigen. Ihr Standort wird automatisch gelöscht,
        sobald der Hilferuf erledigt ist.
      </p>

      <p className="mb-4 text-xs text-muted-foreground">
        Diese Funktion ersetzt nicht den Notruf 112/110. Sie dient
        ausschließlich der nachbarschaftlichen Koordination. Sie können diese
        Einstellung jederzeit in Ihrem Profil ändern.
      </p>
