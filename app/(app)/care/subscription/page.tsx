...
import { SubscriptionCard } from "@/modules/care/components/subscription/SubscriptionCard";
import { SubscriptionPlans } from "@/modules/care/components/subscription/SubscriptionPlans";
  ...
  return (
    <div className="px-4 py-6 space-y-6">
      <PageHeader
        title={
          <>
            <CreditCard className="h-6 w-6 text-quartier-green" /> Ihr Abo-Plan
          </>
        }
        ...
        <div className="rounded-xl bg-green-50 border border-green-200 p-4 text-sm text-[#2D3142] flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Ihr Abo wurde aktiviert. Alle Funktionen stehen Ihnen ab sofort
              zur Verfuegung.
            </p>
          </div>
        </div>
      ...
      {checkout === "cancelled" && (
        <div className="rounded-xl bg-amber-50 border border-amber-200 p-4 text-sm text-[#2D3142] flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Die Zahlung wurde nicht abgeschlossen. Sie koennen es jederzeit
              erneut versuchen.
            </p>
          </div>
        </div>
      ...
      <div className="rounded-xl bg-[#4CAF87]/5 border border-[#4CAF87]/20 p-4 text-sm text-[#2D3142] flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Die ersten 200 Nutzer erhalten alle Funktionen kostenlos — als
            Dankeschoen fuer Ihre fruehe Unterstuetzung.
          </p>
        </div>
      </div>
...
export default function SubscriptionPage() {
  return (
    <Suspense
      fallback={<div className="px-4 py-6 text-muted-foreground">Laden...</div>}
    >
      <SubscriptionContent />
    </Suspense>
  );
