...
| in-progress | codex | G2: Hausverwaltung-RLS-Konsistenz-Audit | `supabase/migrations/181_housing_foundation.sql` + `supabase/migrations/183_housing_feature_flags.sql` + `supabase/migrations/184_quarters_postal_auto_create.sql` + `supabase/migrations/185_housing_invitations.sql` + `__tests__/lib/housing/*` + `docs/plans/handoff/INBOX.md` | 2026-04-30 17:50 +02:00 | audit 181/183/184/185 against current civic roles/schema; fixes only with RED test; no push/prod apply | 2026-04-30 17:50 +02:00 |
