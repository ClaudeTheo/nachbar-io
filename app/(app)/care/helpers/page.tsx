...
import { HelperList } from "@/modules/care/components/helpers/HelperList";
import { HelperRegistrationForm } from "@/modules/care/components/helpers/HelperRegistrationForm";
  ...
  return (
    <div className="px-4 py-6 space-y-6">
      <PageHeader
        title={
          <>
            <Users className="h-6 w-6 text-quartier-green" /> Helfer
          </>
        }
        ...
        actions={
          <button
            ...
            aria-label={
              showForm ? "Formular schliessen" : "Als Helfer registrieren"
            }
          >
            {showForm ? (
              <X className="h-5 w-5" />
