...
describe('RevokeDialog', () => {
  it('zeigt Feature-Label', () => {
    render(
      <RevokeDialog featureLabel="Medikamenten-Verwaltung" onConfirm={vi.fn()} onCancel={vi.fn()} />,
    );
  ...
  it('ruft onConfirm(false) bei "Nur deaktivieren"', () => {
    ...
    render(
      <RevokeDialog featureLabel="Test" onConfirm={onConfirm} onCancel={vi.fn()} />,
    );
  ...
  it('zeigt Bestaetigung bei "Daten loeschen"', () => {
    render(
      <RevokeDialog featureLabel="Test" onConfirm={vi.fn()} onCancel={vi.fn()} />,
    );
  ...
  it('ruft onCancel auf', () => {
    ...
    render(
      <RevokeDialog featureLabel="Test" onConfirm={vi.fn()} onCancel={onCancel} />,
    );
